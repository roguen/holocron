...
**`v0.8.8`.** M1 closed 2026-08-10, ten sessions after its last two criteria were
...
Current version `v0.8.8`. `main` is stable and CI is green. Bump **in the same
